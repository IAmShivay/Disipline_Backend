...
export const newEmployeeTemplate = (employeeDetails: any, autoGeneratedPassword: any) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  <div class="container">
    ...
    <p>Hello ${(employeeDetails.firstName + " " + employeeDetails.lastName).toUpperCase()},</p>
...
<body>
  <div class="container">
    <img src="https://res.cloudinary.com/dyiso4ohk/image/upload/v1734067485/artboard-1-67570223a953f353c6b343ea-_2x_irnjez.png" alt="Company Logo" class="logo">
...
export const appreciationLetterTemplate = (
  employeeDetails: any,
...
`;
export const terminationNoticeTemplate = (
  employeeDetails: any,
...
`;
export const caseUpdatedTemplate = (updatedCaseDetails: any) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  <div class="container">
    ...
    <p>Dear Admin,</p>
    <p>A new response has been received. Below are the details:</p>
    <ul>
